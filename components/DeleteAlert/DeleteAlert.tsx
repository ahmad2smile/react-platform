		...
		return (
			<div>
				...
				>
					...
					<DialogTitle classes={{ root: classes.root }} id="alert-dialog-slide-title">
					...
					<DialogContent classes={{ root: classes.root }}>
						...
						>
							Deleting the store will also delete its custom departments, positions,
							tasks, benefits, exemptions and budgets and time off requests
						</DialogContentText>
					</DialogContent>
					<DialogActions>
